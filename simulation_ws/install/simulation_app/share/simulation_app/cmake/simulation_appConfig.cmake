...
if("FALSE" STREQUAL "TRUE")
  set(simulation_app_SOURCE_PREFIX /home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/src/simulation_app)
  set(simulation_app_DEVEL_PREFIX /home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/build/simulation_app/devel)
  ...
  set(simulation_app_INSTALL_PREFIX /home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/install/simulation_app)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulation_app' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/install/simulation_app/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/install/simulation_app/lib;/home/nick/aws-robomaker-sample-application-roverrobotics/robot_ws/install/robot_app/lib;/opt/ros/melodic/lib)
