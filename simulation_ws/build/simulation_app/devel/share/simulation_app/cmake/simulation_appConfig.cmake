...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulation_app' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/src/simulation_app/${idir}'.  ${_report}")
    endif()
