...
// (in-package rr_openrover_basic.msg)
...
class RawRrOpenroverBasicSlowRateData {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RawRrOpenroverBasicSlowRateData(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RawRrOpenroverBasicSlowRateData(null);
...
module.exports = RawRrOpenroverBasicSlowRateData;
