...
;//! \htmlinclude RawRrOpenroverBasicSlowRateData.msg.html

(cl:defclass <RawRrOpenroverBasicSlowRateData> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass RawRrOpenroverBasicSlowRateData (<RawRrOpenroverBasicSlowRateData>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RawRrOpenroverBasicSlowRateData>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RawRrOpenroverBasicSlowRateData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rr_openrover_basic-msg:<RawRrOpenroverBasicSlowRateData> is deprecated: use rr_openrover_basic-msg:RawRrOpenroverBasicSlowRateData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RawRrOpenroverBasicSlowRateData>))
...
(cl:defmethod reg_motor_fault_flag_left-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_fault_flag_left-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_fault_flag_left instead.")
  (reg_motor_fault_flag_left m))

(cl:ensure-generic-function 'reg_motor_temp_left-val :lambda-list '(m))
(cl:defmethod reg_motor_temp_left-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_temp_left-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_temp_left instead.")
  (reg_motor_temp_left m))

(cl:ensure-generic-function 'reg_motor_temp_right-val :lambda-list '(m))
(cl:defmethod reg_motor_temp_right-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_temp_right-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_temp_right instead.")
  (reg_motor_temp_right m))

(cl:ensure-generic-function 'reg_power_bat_voltage_a-val :lambda-list '(m))
(cl:defmethod reg_power_bat_voltage_a-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_power_bat_voltage_a-val is deprecated.  Use rr_openrover_basic-msg:reg_power_bat_voltage_a instead.")
  (reg_power_bat_voltage_a m))

(cl:ensure-generic-function 'reg_power_bat_voltage_b-val :lambda-list '(m))
(cl:defmethod reg_power_bat_voltage_b-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_power_bat_voltage_b-val is deprecated.  Use rr_openrover_basic-msg:reg_power_bat_voltage_b instead.")
  (reg_power_bat_voltage_b m))

(cl:ensure-generic-function 'reg_robot_rel_soc_a-val :lambda-list '(m))
(cl:defmethod reg_robot_rel_soc_a-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_robot_rel_soc_a-val is deprecated.  Use rr_openrover_basic-msg:reg_robot_rel_soc_a instead.")
  (reg_robot_rel_soc_a m))

(cl:ensure-generic-function 'reg_robot_rel_soc_b-val :lambda-list '(m))
(cl:defmethod reg_robot_rel_soc_b-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_robot_rel_soc_b-val is deprecated.  Use rr_openrover_basic-msg:reg_robot_rel_soc_b instead.")
  (reg_robot_rel_soc_b m))

(cl:ensure-generic-function 'battery_mode_a-val :lambda-list '(m))
(cl:defmethod battery_mode_a-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_mode_a-val is deprecated.  Use rr_openrover_basic-msg:battery_mode_a instead.")
  (battery_mode_a m))

(cl:ensure-generic-function 'battery_mode_b-val :lambda-list '(m))
(cl:defmethod battery_mode_b-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_mode_b-val is deprecated.  Use rr_openrover_basic-msg:battery_mode_b instead.")
  (battery_mode_b m))

(cl:ensure-generic-function 'battery_temp_a-val :lambda-list '(m))
(cl:defmethod battery_temp_a-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_temp_a-val is deprecated.  Use rr_openrover_basic-msg:battery_temp_a instead.")
  (battery_temp_a m))

(cl:ensure-generic-function 'battery_temp_b-val :lambda-list '(m))
(cl:defmethod battery_temp_b-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_temp_b-val is deprecated.  Use rr_openrover_basic-msg:battery_temp_b instead.")
  (battery_temp_b m))

(cl:ensure-generic-function 'battery_voltage_a-val :lambda-list '(m))
(cl:defmethod battery_voltage_a-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_voltage_a-val is deprecated.  Use rr_openrover_basic-msg:battery_voltage_a instead.")
  (battery_voltage_a m))

(cl:ensure-generic-function 'battery_voltage_b-val :lambda-list '(m))
(cl:defmethod battery_voltage_b-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_voltage_b-val is deprecated.  Use rr_openrover_basic-msg:battery_voltage_b instead.")
  (battery_voltage_b m))

(cl:ensure-generic-function 'buildno-val :lambda-list '(m))
(cl:defmethod buildno-val ((m <RawRrOpenroverBasicSlowRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:buildno-val is deprecated.  Use rr_openrover_basic-msg:buildno instead.")
  (buildno m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RawRrOpenroverBasicSlowRateData>) ostream)
  "Serializes a message object of type '<RawRrOpenroverBasicSlowRateData>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RawRrOpenroverBasicSlowRateData>) istream)
  "Deserializes a message object of type '<RawRrOpenroverBasicSlowRateData>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RawRrOpenroverBasicSlowRateData>)))
  "Returns string type for a message object of type '<RawRrOpenroverBasicSlowRateData>"
  "rr_openrover_basic/RawRrOpenroverBasicSlowRateData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RawRrOpenroverBasicSlowRateData)))
  "Returns string type for a message object of type 'RawRrOpenroverBasicSlowRateData"
  "rr_openrover_basic/RawRrOpenroverBasicSlowRateData")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RawRrOpenroverBasicSlowRateData>)))
  "Returns md5sum for a message object of type '<RawRrOpenroverBasicSlowRateData>"
  "81c26593ff4507cd00407918de2b2593")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RawRrOpenroverBasicSlowRateData)))
  "Returns md5sum for a message object of type 'RawRrOpenroverBasicSlowRateData"
  "81c26593ff4507cd00407918de2b2593")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RawRrOpenroverBasicSlowRateData>)))
  "Returns full string definition for message of type '<RawRrOpenroverBasicSlowRateData>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RawRrOpenroverBasicSlowRateData)))
  "Returns full string definition for message of type 'RawRrOpenroverBasicSlowRateData"
  (cl:format cl:nil "Header header~%int32 reg_motor_fault_flag_left~%int32 reg_motor_temp_left~%int32 reg_motor_temp_right~%int32 reg_power_bat_voltage_a~%int32 reg_power_bat_voltage_b~%int32 reg_robot_rel_soc_a~%int32 reg_robot_rel_soc_b~%uint16 battery_mode_a~%uint16 battery_mode_b~%uint16 battery_temp_a~%uint16 battery_temp_b~%uint16 battery_voltage_a~%uint16 battery_voltage_b~%int32 buildno~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RawRrOpenroverBasicSlowRateData>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RawRrOpenroverBasicSlowRateData>))
  "Converts a ROS message object to a list"
  (cl:list 'RawRrOpenroverBasicSlowRateData
