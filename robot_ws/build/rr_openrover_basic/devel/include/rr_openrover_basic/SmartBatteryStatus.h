// Generated by gencpp from file rr_openrover_basic/SmartBatteryStatus.msg
// DO NOT EDIT!


#ifndef RR_OPENROVER_BASIC_MESSAGE_SMARTBATTERYSTATUS_H
#define RR_OPENROVER_BASIC_MESSAGE_SMARTBATTERYSTATUS_H
...
struct SmartBatteryStatus_
{
  ...
  typedef boost::shared_ptr< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> const> ConstPtr;

}; // struct SmartBatteryStatus_

typedef ::rr_openrover_basic::SmartBatteryStatus_<std::allocator<void> > SmartBatteryStatus;

typedef boost::shared_ptr< ::rr_openrover_basic::SmartBatteryStatus > SmartBatteryStatusPtr;
typedef boost::shared_ptr< ::rr_openrover_basic::SmartBatteryStatus const> SmartBatteryStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa952a8feedea27caULL;
  static const uint64_t static_value2 = 0xb4667095d349334cULL;
};

template<class ContainerAllocator>
struct DataType< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rr_openrover_basic::SmartBatteryStatus_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RR_OPENROVER_BASIC_MESSAGE_SMARTBATTERYSTATUS_H
