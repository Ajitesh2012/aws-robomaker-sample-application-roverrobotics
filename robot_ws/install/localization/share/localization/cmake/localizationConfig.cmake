...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nick/aws-robomaker-sample-application-roverrobotics/robot_ws/install/localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nick/aws-robomaker-sample-application-roverrobotics/robot_ws/install/localization/lib;/home/nick/aws-robomaker-sample-application-roverrobotics/simulation_ws/install/simulation_app/lib;/opt/ros/melodic/lib)
