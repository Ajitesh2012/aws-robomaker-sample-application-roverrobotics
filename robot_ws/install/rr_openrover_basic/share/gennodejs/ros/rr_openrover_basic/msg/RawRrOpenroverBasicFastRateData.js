...
class RawRrOpenroverBasicFastRateData {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RawRrOpenroverBasicFastRateData(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RawRrOpenroverBasicFastRateData(null);
...
module.exports = RawRrOpenroverBasicFastRateData;
