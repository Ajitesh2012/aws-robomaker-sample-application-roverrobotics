...
class RawRrOpenroverBasicMedRateData {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RawRrOpenroverBasicMedRateData(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RawRrOpenroverBasicMedRateData(null);
...
module.exports = RawRrOpenroverBasicMedRateData;
