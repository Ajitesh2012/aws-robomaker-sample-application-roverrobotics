...
;//! \htmlinclude RawRrOpenroverBasicMedRateData.msg.html

(cl:defclass <RawRrOpenroverBasicMedRateData> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass RawRrOpenroverBasicMedRateData (<RawRrOpenroverBasicMedRateData>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RawRrOpenroverBasicMedRateData>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RawRrOpenroverBasicMedRateData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rr_openrover_basic-msg:<RawRrOpenroverBasicMedRateData> is deprecated: use rr_openrover_basic-msg:RawRrOpenroverBasicMedRateData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RawRrOpenroverBasicMedRateData>))
...
(cl:defmethod reg_pwr_total_current-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_pwr_total_current-val is deprecated.  Use rr_openrover_basic-msg:reg_pwr_total_current instead.")
  (reg_pwr_total_current m))

(cl:ensure-generic-function 'reg_motor_fb_rpm_left-val :lambda-list '(m))
(cl:defmethod reg_motor_fb_rpm_left-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_fb_rpm_left-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_fb_rpm_left instead.")
  (reg_motor_fb_rpm_left m))

(cl:ensure-generic-function 'reg_motor_fb_rpm_right-val :lambda-list '(m))
(cl:defmethod reg_motor_fb_rpm_right-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_fb_rpm_right-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_fb_rpm_right instead.")
  (reg_motor_fb_rpm_right m))

(cl:ensure-generic-function 'reg_flipper_fb_position_pot1-val :lambda-list '(m))
(cl:defmethod reg_flipper_fb_position_pot1-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_flipper_fb_position_pot1-val is deprecated.  Use rr_openrover_basic-msg:reg_flipper_fb_position_pot1 instead.")
  (reg_flipper_fb_position_pot1 m))

(cl:ensure-generic-function 'reg_flipper_fb_position_pot2-val :lambda-list '(m))
(cl:defmethod reg_flipper_fb_position_pot2-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_flipper_fb_position_pot2-val is deprecated.  Use rr_openrover_basic-msg:reg_flipper_fb_position_pot2 instead.")
  (reg_flipper_fb_position_pot2 m))

(cl:ensure-generic-function 'reg_motor_fb_current_left-val :lambda-list '(m))
(cl:defmethod reg_motor_fb_current_left-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_fb_current_left-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_fb_current_left instead.")
  (reg_motor_fb_current_left m))

(cl:ensure-generic-function 'reg_motor_fb_current_right-val :lambda-list '(m))
(cl:defmethod reg_motor_fb_current_right-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_fb_current_right-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_fb_current_right instead.")
  (reg_motor_fb_current_right m))

(cl:ensure-generic-function 'reg_motor_charger_state-val :lambda-list '(m))
(cl:defmethod reg_motor_charger_state-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_charger_state-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_charger_state instead.")
  (reg_motor_charger_state m))

(cl:ensure-generic-function 'reg_power_a_current-val :lambda-list '(m))
(cl:defmethod reg_power_a_current-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_power_a_current-val is deprecated.  Use rr_openrover_basic-msg:reg_power_a_current instead.")
  (reg_power_a_current m))

(cl:ensure-generic-function 'reg_power_b_current-val :lambda-list '(m))
(cl:defmethod reg_power_b_current-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_power_b_current-val is deprecated.  Use rr_openrover_basic-msg:reg_power_b_current instead.")
  (reg_power_b_current m))

(cl:ensure-generic-function 'reg_motor_flipper_angle-val :lambda-list '(m))
(cl:defmethod reg_motor_flipper_angle-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:reg_motor_flipper_angle-val is deprecated.  Use rr_openrover_basic-msg:reg_motor_flipper_angle instead.")
  (reg_motor_flipper_angle m))

(cl:ensure-generic-function 'battery_current_a-val :lambda-list '(m))
(cl:defmethod battery_current_a-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_current_a-val is deprecated.  Use rr_openrover_basic-msg:battery_current_a instead.")
  (battery_current_a m))

(cl:ensure-generic-function 'battery_current_b-val :lambda-list '(m))
(cl:defmethod battery_current_b-val ((m <RawRrOpenroverBasicMedRateData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_openrover_basic-msg:battery_current_b-val is deprecated.  Use rr_openrover_basic-msg:battery_current_b instead.")
  (battery_current_b m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RawRrOpenroverBasicMedRateData>) ostream)
  "Serializes a message object of type '<RawRrOpenroverBasicMedRateData>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RawRrOpenroverBasicMedRateData>) istream)
  "Deserializes a message object of type '<RawRrOpenroverBasicMedRateData>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RawRrOpenroverBasicMedRateData>)))
  "Returns string type for a message object of type '<RawRrOpenroverBasicMedRateData>"
  "rr_openrover_basic/RawRrOpenroverBasicMedRateData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RawRrOpenroverBasicMedRateData)))
  "Returns string type for a message object of type 'RawRrOpenroverBasicMedRateData"
  "rr_openrover_basic/RawRrOpenroverBasicMedRateData")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RawRrOpenroverBasicMedRateData>)))
  "Returns md5sum for a message object of type '<RawRrOpenroverBasicMedRateData>"
  "8d1326600b05770e80fedaabbf1fed8a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RawRrOpenroverBasicMedRateData)))
  "Returns md5sum for a message object of type 'RawRrOpenroverBasicMedRateData"
  "8d1326600b05770e80fedaabbf1fed8a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RawRrOpenroverBasicMedRateData>)))
  "Returns full string definition for message of type '<RawRrOpenroverBasicMedRateData>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RawRrOpenroverBasicMedRateData)))
  "Returns full string definition for message of type 'RawRrOpenroverBasicMedRateData"
  (cl:format cl:nil "Header header~%int32 reg_pwr_total_current~%int32 reg_motor_fb_rpm_left~%int32 reg_motor_fb_rpm_right~%int32 reg_flipper_fb_position_pot1~%int32 reg_flipper_fb_position_pot2~%int32 reg_motor_fb_current_left~%int32 reg_motor_fb_current_right~%int32 reg_motor_charger_state~%int32 reg_power_a_current~%int32 reg_power_b_current~%int32 reg_motor_flipper_angle~%int16 battery_current_a~%int16 battery_current_b~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RawRrOpenroverBasicMedRateData>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RawRrOpenroverBasicMedRateData>))
  "Converts a ROS message object to a list"
  (cl:list 'RawRrOpenroverBasicMedRateData
